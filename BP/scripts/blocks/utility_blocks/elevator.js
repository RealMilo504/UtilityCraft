...
world.beforeEvents.worldInitialize.subscribe(eventData => {
    eventData.blockComponentRegistry.registerCustomComponent('utilitycraft:elevator', {
        onStepOff(e) {
            const { block } = e
            ...
            if (player.isJumping && !player.isSneaking) {
                for (var y = y; y < ymax; y++) {
                    if (block.dimension.getBlock({ x: block.location.x, y, z: block.location.z }).typeId == 'utilitycraft:elevator') {
                        y++
