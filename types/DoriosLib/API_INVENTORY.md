...
- Entities and items: `InventoryEntry`, `SetItemOptions`, `SetNewItemOptions`, `TryAddItemOptions`, `AddItemResult`, `ChangeItemAmountOptions`, `HealthInfo`, `SetEquipmentOptions`, `CreateItemOptions`, `DurabilityInfo`, `DamageResult`, `GiveItemOptions`.
