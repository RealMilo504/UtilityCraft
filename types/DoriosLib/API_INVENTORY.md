...
- Core aliases: `BlockStateValue`, `ContainerFace`, `ScaleMode`, `LinkNodeIOResource`, `LinkNodeIOOperation`, `RegistrationPayload`, `ItemDuctCompatibilityRegistration`, `LinkNodeIORegistration`, `JsonResult`.
